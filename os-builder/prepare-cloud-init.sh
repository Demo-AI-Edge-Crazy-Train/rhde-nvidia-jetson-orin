...
declare -a ALL_CONFIG_VARS=(CLOUD_INIT_RH_ACTIVATION_KEY CLOUD_INIT_RH_ORGANIZATION_ID CLOUD_INIT_ADMIN_USERNAME CLOUD_INIT_ADMIN_SSH_KEY CLOUD_INIT_ADMIN_PASSWORD)

...
declare -a ALL_CONFIG_VARS=(KICKSTART_WIFI_SSID KICKSTART_WIFI_WPA_KEY KICKSTART_WIFI_MAC_ADDRESS BLUEPRINT_ADMIN_USERNAME BLUEPRINT_ADMIN_SSH_KEY BLUEPRINT_ADMIN_PASSWORD KICKSTART_OSTREE_URL KICKSTART_OSTREE_REF KICKSTART_MICROSHIFT_PULL_SECRET)
...
if [ -z "${KICKSTART_WIFI_MAC_ADDRESS:-}" ]; then read -p "Wifi MAC Address: " KICKSTART_WIFI_MAC_ADDRESS; fi
